...
public class PasswordService {
    ...
    */
    public Password customizedPassword(CustomPasswordFilter cPW) {
        ...
        if (Objects.equals(cPW.symbols, "true") && Objects.equals(cPW.uppercase, "true")
                && Objects.equals(cPW.lowercase, "true") && Objects.equals(cPW.numbers, "true")){

            // All set
            passwordFunction = this::randomASCIIBetween33and126;

        } else if (Objects.equals(cPW.symbols, "true") && Objects.equals(cPW.uppercase, "true")
                && Objects.equals(cPW.lowercase, "false") &&Objects.equals(cPW.numbers, "true")){

            // lowercase is null
            passwordFunction = this::randomASCIINoLowercase;

        } else if (Objects.equals(cPW.symbols, "true") && Objects.equals(cPW.uppercase, "false")
                && Objects.equals(cPW.lowercase, "true") && Objects.equals(cPW.numbers, "true")){
            ...
            passwordFunction = this::randomASCIINoUppercaseNoLowercase;
                ...
                && Objects.equals(cPW.lowercase, "true") && Objects.equals(cPW.numbers, "false")){

            // numbers is null
            passwordFunction = this::randomASCIINoNumbers;

        } else if (Objects.equals(cPW.symbols, "true") && Objects.equals(cPW.uppercase, "true")
                && Objects.equals(cPW.lowercase, "false") && Objects.equals(cPW.numbers, "false")){
        ...
        } else if (Objects.equals(cPW.symbols, "false") && Objects.equals(cPW.uppercase, "true")
                && Objects.equals(cPW.lowercase, "true") && Objects.equals(cPW.numbers, "true")){
        ...
        } else if (Objects.equals(cPW.symbols, "false") && Objects.equals(cPW.uppercase, "false")
                && Objects.equals(cPW.lowercase, "true") && Objects.equals(cPW.numbers, "true")){
